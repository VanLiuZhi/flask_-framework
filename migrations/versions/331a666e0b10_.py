...
Revision ID: 331a666e0b10
Revises: 
Create Date: 2019-02-09 02:01:02.595260
...
def upgrade():
    ...
    op.create_index('idx_ti_tk', 'comment_items', ['target_id', 'target_kind', 'user_id'], unique=False)
    ...
    op.create_index('idx_ti', 'like_items', ['target_id', 'target_kind', 'user_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index('idx_ti', table_name='like_items')
    ...
    op.drop_index('idx_ti_tk', table_name='comment_items')
